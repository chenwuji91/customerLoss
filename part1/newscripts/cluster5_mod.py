    ...
    with open(trainfile) as fin:
        ...
        for line in fin:
            ...
            for i in xrange(len(data)):
                if data[i] == "NULL":
                    data[i] = -1 
            train_X.append([float(data[8]),float(data[12]),float(data[14]),float(data[17]),float(data[21])])
    ...
    with open(testfile) as fin:
        ...
        for line in fin:
            ...
            for i in xrange(len(data)):
                if data[i] == "NULL":
                    data[i] = -1
            test_X.append([float(data[8]),float(data[12]),float(data[14]),float(data[17]),float(data[21])])
